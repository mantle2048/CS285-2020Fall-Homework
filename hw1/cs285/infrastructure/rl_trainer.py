...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        if itr == 0:
            import pickle
            fr = open(load_initial_expertdata, 'rb')
    ...
    def train_agent(self):
        ...
        all_logs = []
        for train_step in range(self.params['num_agent_train_steps_per_iter'] + 1):
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        for i in len(paths):
            expert_acts = self.agent.get_action(paths[i]["observation"])
